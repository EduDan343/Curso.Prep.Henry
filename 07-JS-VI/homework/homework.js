...
function forEach(array, cb) {
  ...
  //otra forma en el solucionario
  // array.forEach(function(el, index) {
  //   cb(el);
  // });

  //forma tradicional o de la forma donde tenemos que hacer toda la logica
...
function filter(array) {
  ...
  //Solucion propuesta en el solucionario con bucle for normal
  /*
    var nuevoArray = [];
