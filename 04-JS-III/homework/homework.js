...
var array2 = ['perro','gato']
console.log(agregarItemAlComienzoDelArray(array2,'pez'))
...
function mayorACien(array) {
  ...
  for(var i=0; i < array.length; i++)
  {
    if(array[i] > 100 && array[i] <=200){ numeros.push(array[i])}
  }
  return numeros;
}
